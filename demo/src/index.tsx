...
class App extends React.Component<{}, { expanded: UUID[] }> {
    constructor() {
        super({});
        this.state = { expanded: [] };
    ...
    handleChange(expanded: UUID[]): void {
    ...
    render(): JSX.Element {
        return (
            <>
                ...
                <p>
                    React Component for creating an 'Accordion' that adheres to
                    the{' '}
                    <a
                ...
                <p>
                    ...
                    <strong>true</strong> then the accordion will permit
                ...
                <p>
                    ...
                    <strong>true</strong> then a solitary expanded item may be
                    collapsed again.
                </p>
                ...
                <p>
                    If you set <strong>preExpanded</strong>, then you can choose
                    which items are expanded on mount.
                </p>

                <p>
                    The strings passed to <strong>preExpanded</strong> are
                    directly related to the <strong>uuid</strong> props of{' '}
                ...
                <p>
                    In this example, we are simply logging the uuids of the
                    expanded items to the console. Have a click around then
                ...
                <p>
                    ...
                    the <strong>expanded</strong> or <strong>disabled</strong>{' '}
                    state of an item, you might like to use the{' '}
                ...
                <h2 className="u-margin-top">
                    Programmatic Control of Expanded
                </h2>
